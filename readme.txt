...
- Synchronised to your Selz account and inventory
- Sell physical products, digital products and services
- Built in payment processing
- 24/7 award winning live support
...
== Changelog ==
= 2.2.0 =
- Added block migration capabilities for iZettle merchants
= 2.1.12 =
- General maintenance
= 2.1.11 =
- Fixed issue preventing categories from loading in the Category panel
= 2.1.10 =
...
- General maintenance
= 2.1.5 =
- Fixed issue preventing Gutenberg editor from loading
= 2.1.4 =
- Update introductory video
= 2.1.3 =
- Branding updates
= 2.1.2 =
- Minor bug fix preventing plugin conflicts
= 2.1.1 =
- Minor bug fix
= 2.1.0 =
